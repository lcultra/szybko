...
> 日期: 2026-07-01
> 状态: **已归档** — 被 `docs/superpowers/specs/szybko/` 目录下的拆分文档集取代。
> AI 执行时请使用该目录下的文档集，而非本文。
...
| 工具库 | dayjs, uuid, zustand | 日期处理、运行时校验、ID 生成、轻量状态管理 |
